...
def test_image_pins_merged_phase_two_revisions():
    assert "efb-telegram-master.git@3758c5c99aa2c39d824a1bd247cd0dacfb581c8c" in DOCKERFILE
    ...
    assert 'ENV EFB_IMAGE_REVISION "3758c5c-31549fb-http687e237-' in DOCKERFILE
    assert "bridge-13d443a-watchdog-0b343fa" in DOCKERFILE
    assert 'ENV EFB_TELEGRAM_MASTER_REVISION "3758c5c99aa2c39d824a1bd247cd0dacfb581c8c"' in DOCKERFILE
