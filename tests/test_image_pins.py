...
def test_image_pins_merged_phase_two_revisions():
    assert "efb-telegram-master.git@2a376c1ff982917f37f5ed7666e1409cf8863be6" in DOCKERFILE
    ...
    assert 'ENV EFB_IMAGE_REVISION "2a376c1-31549fb-http687e237-' in DOCKERFILE
    assert "bridge-13d443a-watchdog-0b343fa" in DOCKERFILE
    assert 'ENV EFB_TELEGRAM_MASTER_REVISION "2a376c1ff982917f37f5ed7666e1409cf8863be6"' in DOCKERFILE
