...
RUN pip3 install --no-cache-dir git+https://github.com/shaoyou11/ehforwarderbot-core.git@abf737397cdea2dde991b0cb547877157a031cf7 python-telegram-bot pyqrcode; \
    ...
    pip3 install --no-cache-dir git+https://github.com/shaoyou11/efb-telegram-master.git@29ae00a; \
    pip3 install --no-cache-dir git+https://github.com/shaoyou11/python-comwechatrobot-http.git@83d51a0; \
    pip3 install --no-cache-dir git+https://github.com/shaoyou11/efb-wechat-comwechat-slave.git@938e3cd; \
...
ENV EFB_IMAGE_REVISION "29ae00a-938e3cd-http83d51a0-mw-abed7e6-51f360e-bridge-2032f50-watchdog-f944525"
ENV HTTPS_PROXY ""
