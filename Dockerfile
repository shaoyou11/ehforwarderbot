...
RUN pip3 install --no-cache-dir --constraint /tmp/constraints.lock git+https://github.com/shaoyou11/ehforwarderbot-core.git@abf737397cdea2dde991b0cb547877157a031cf7 python-telegram-bot pyqrcode; \
    ...
    pip3 install --no-cache-dir --constraint /tmp/constraints.lock git+https://github.com/shaoyou11/efb-telegram-master.git@d6a9caab49fdde6159607543ceb513fe0e27e38b; \
    pip3 install --no-cache-dir --constraint /tmp/constraints.lock git+https://github.com/shaoyou11/python-comwechatrobot-http.git@61cc53a95a1caee13e9c51309b2f305e5edb80f8; \
    pip3 install --no-cache-dir --constraint /tmp/constraints.lock git+https://github.com/shaoyou11/efb-wechat-comwechat-slave.git@b68d78838813cb8abbff004f4f3ac3ceaa8d0b96; \
...
ENV EFB_IMAGE_REVISION "d6a9caa-b68d788-http61cc53a-mw-abed7e6-51f360e-bridge-2032f50-watchdog-697275d"
