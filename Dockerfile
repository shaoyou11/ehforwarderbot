...
RUN pip3 install --no-cache-dir --constraint /tmp/constraints.lock git+https://github.com/shaoyou11/ehforwarderbot-core.git@abf737397cdea2dde991b0cb547877157a031cf7 python-telegram-bot pyqrcode; \
    ...
    pip3 install --no-cache-dir --constraint /tmp/constraints.lock git+https://github.com/shaoyou11/efb-telegram-master.git@2a376c1ff982917f37f5ed7666e1409cf8863be6; \
...
ENV EFB_IMAGE_REVISION "2a376c1-31549fb-http687e237-mw-abed7e6-51f360e-bridge-13d443a-watchdog-0b343fa"
ENV EFB_CORE_REVISION "${EFB_IMAGE_SOURCE_REF}"
ENV EFB_TELEGRAM_MASTER_REVISION "2a376c1ff982917f37f5ed7666e1409cf8863be6"
